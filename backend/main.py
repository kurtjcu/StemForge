...
from backend.api import system, audio, separate, midi, generate, mix, export, compose, sfx
...
for d in (OUTPUT_BASE, STEMS_DIR, MIDI_DIR, MUSICGEN_DIR, MIX_DIR, EXPORT_DIR, COMPOSE_DIR, SFX_DIR):
