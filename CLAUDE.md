...
- **Enhance** — three-mode vocal enhancement tab:
  ...
  - **Tune** — auto-tune via CREPE neural pitch detection (`torchcrepe`) + WORLD vocoder resynthesis (`pyworld`); scale snapping with correction strength and humanization controls
